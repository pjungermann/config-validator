...
/**
 * Tests for {@link UnsupportedCollectionEntryPropertyError}.
 *
 * @author patrick.jungermann
 * @since 2016-07-27
 */
public class UnsupportedCollectionEntryPropertyErrorTest {
    ...
    public void getMessageCode_always_correctCode() {
        ...
        UnsupportedCollectionEntryPropertyError error =
                new UnsupportedCollectionEntryPropertyError(key, "invalid value");

        assertEquals("error.collection.property.unsupported", error.getMessageCode());
    }
