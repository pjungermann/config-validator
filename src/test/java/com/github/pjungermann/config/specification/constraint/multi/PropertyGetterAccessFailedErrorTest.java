...
/**
 * Tests for {@link PropertyGetterAccessFailedError}.
 *
 * @author patrick.jungermann
 * @since 2016-07-27
 */
public class PropertyGetterAccessFailedErrorTest {
    ...
    public void getMessageCode_always_correctCode() {
        ...
        PropertyGetterAccessFailedError error =
                new PropertyGetterAccessFailedError(key, "invalid value", "fake-getter");

        assertEquals("errors.collection.entry.property.getter.access_failed", error.getMessageCode());
    }
