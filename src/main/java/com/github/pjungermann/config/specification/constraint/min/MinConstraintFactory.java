...
/**
 * Creates a {@link MinConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class MinConstraintFactory implements ConstraintFactory<MinConstraint> {

    @NotNull
    @Override
    public MinConstraint create(@NotNull final String key,
                                @Nullable final Object expectation,
                                @NotNull final SourceLine sourceLine) {
        return new MinConstraint(key, expectation, sourceLine);
    }
