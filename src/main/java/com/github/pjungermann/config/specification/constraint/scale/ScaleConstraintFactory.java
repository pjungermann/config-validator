...
/**
 * Creates a {@link ScaleConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class ScaleConstraintFactory implements ConstraintFactory<ScaleConstraint> {

    @NotNull
    @Override
    public ScaleConstraint create(@NotNull final String key,
                                  @Nullable final Object expectation,
                                  @NotNull final SourceLine sourceLine) {
        return new ScaleConstraint(key, expectation, sourceLine);
    }
}
