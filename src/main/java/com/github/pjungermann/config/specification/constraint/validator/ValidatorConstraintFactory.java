...
/**
 * Creates a {@link ValidatorConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class ValidatorConstraintFactory implements ConstraintFactory<ValidatorConstraint> {

    @NotNull
    @Override
    public ValidatorConstraint create(@NotNull final String key,
                                      @Nullable final Object expectation,
                                      @NotNull final SourceLine sourceLine) {
        return new ValidatorConstraint(key, expectation, sourceLine);
    }
}
