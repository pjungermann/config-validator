...
/**
 * Used when the collection's entry's field exists,
 * but was not accessible.
 *
 * @author patrick.jungermann
 * @since 2016-07-27
 */
public class PropertyFieldAccessFailedError implements ConfigError {

    private final CollectionKey key;
    private final Object entry;
    private final String fieldName;

    public PropertyFieldAccessFailedError(@NotNull final CollectionKey key,
    ...
    protected String getMessageCode() {
        return "errors.collection.entry.property.field.access_failed";
    }
