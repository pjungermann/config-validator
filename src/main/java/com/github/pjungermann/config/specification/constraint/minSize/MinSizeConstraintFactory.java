...
/**
 * Creates a {@link MinSizeConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class MinSizeConstraintFactory implements ConstraintFactory<MinSizeConstraint> {

    @NotNull
    @Override
    public MinSizeConstraint create(@NotNull final String key,
                                    @Nullable final Object expectation,
                                    @NotNull final SourceLine sourceLine) {
        return new MinSizeConstraint(key, expectation, sourceLine);
    }
}
