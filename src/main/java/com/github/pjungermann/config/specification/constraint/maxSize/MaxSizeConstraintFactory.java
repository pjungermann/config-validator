...
/**
 * Creates a {@link MaxSizeConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class MaxSizeConstraintFactory implements ConstraintFactory<MaxSizeConstraint> {

    @NotNull
    @Override
    public MaxSizeConstraint create(@NotNull final String key,
                                    @Nullable final Object expectation,
                                    @NotNull final SourceLine sourceLine) {
        return new MaxSizeConstraint(key, expectation, sourceLine);
    }
}
