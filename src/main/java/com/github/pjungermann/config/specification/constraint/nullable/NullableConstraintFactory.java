...
/**
 * Creates {@link NullableConstraint} instances.
 *
 * @author Patrick Jungermann
 */
@Component
public class NullableConstraintFactory implements ConstraintFactory<NullableConstraint> {

    @NotNull
    @Override
    public NullableConstraint create(@NotNull final String key,
                                     @Nullable final Object expectation,
                                     @NotNull final SourceLine sourceLine) {
        return new NullableConstraint(key, expectation, sourceLine);
    }
}
