...
/**
 * Creates {@link BlankConstraint} instances.
 *
 * @author Patrick Jungermann
 */
@Component
public class BlankConstraintFactory implements ConstraintFactory<BlankConstraint> {

    @NotNull
    @Override
    public BlankConstraint create(@NotNull final String key,
                                  @Nullable final Object expectation,
                                  @NotNull final SourceLine sourceLine) {
        return new BlankConstraint(key, expectation, sourceLine);
    }
}
