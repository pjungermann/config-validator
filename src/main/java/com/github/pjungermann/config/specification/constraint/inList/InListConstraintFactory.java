...
/**
 * Creates a {@link InListConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class InListConstraintFactory implements ConstraintFactory<InListConstraint> {

    @NotNull
    @Override
    public InListConstraint create(@NotNull final String key,
                                   @Nullable final Object expectation,
                                   @NotNull final SourceLine sourceLine) {
        return new InListConstraint(key, expectation, sourceLine);
    }
}
