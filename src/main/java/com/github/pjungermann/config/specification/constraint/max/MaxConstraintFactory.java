...
/**
 * Creates a {@link MaxConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class MaxConstraintFactory implements ConstraintFactory<MaxConstraint> {

    @NotNull
    @Override
    public MaxConstraint create(@NotNull final String key,
                                @Nullable final Object expectation,
                                @NotNull final SourceLine sourceLine) {
        return new MaxConstraint(key, expectation, sourceLine);
    }
}
