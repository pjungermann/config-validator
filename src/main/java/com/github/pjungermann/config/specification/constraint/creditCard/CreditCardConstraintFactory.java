...
/**
 * Creates a {@link CreditCardConstraint}.
 *
 * @author Patrick Jungermann
 */
@Component
public class CreditCardConstraintFactory implements ConstraintFactory<CreditCardConstraint> {

    @NotNull
    @Override
    public CreditCardConstraint create(@NotNull final String key,
                                       @Nullable final Object expectation,
                                       @NotNull final SourceLine sourceLine) {
        return new CreditCardConstraint(key, expectation, sourceLine);
    }
}
