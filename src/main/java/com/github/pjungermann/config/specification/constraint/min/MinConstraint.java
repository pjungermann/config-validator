...
/**
 * Checks whether a numerical value is not smaller than a provided min value.
 *
 * @author Patrick Jungermann
 */
public class MinConstraint extends AbstractNumericalConstraint {
     ...
     */
    public MinConstraint(@NotNull final String key,
    ...
    protected ConfigError doValidate(final Number value, final Number expectation) {
