 ...
 */
@Component
public class EmailConstraintFactory implements ConstraintFactory<EmailConstraint> {

    @NotNull
    @Override
    public EmailConstraint create(@NotNull final String key,
                                  @Nullable final Object expectation,
                                  @NotNull final SourceLine sourceLine) {
        return new EmailConstraint(key, expectation, sourceLine);
    }
}
